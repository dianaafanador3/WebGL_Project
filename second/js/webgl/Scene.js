var Scene = {
    ...
    addObject : function(object,attributes,callback) {
       ...
       if (object.scalars){
		...
		var textureBufferObject1;
		if (object.texture_coords1){
			textureBufferObject1 = gl.createBuffer();
			gl.bindBuffer(gl.ARRAY_BUFFER, textureBufferObject1);
			alert(object.texture_coords1);
			gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(object.texture_coords1), gl.STATIC_DRAW);
			object.tbo1 = textureBufferObject1;
		}
